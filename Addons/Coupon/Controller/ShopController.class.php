...
class ShopController extends AddonsController {
	...
	function lists() {
	    ...
	    $normal_tips = '门店导航显示链接  (请得到微信打开)：<a id="copyLink" data-clipboard-text="'.addons_url('Card://Wap/storeList',array('publicid'=>$public_info['id'])).'">复制链接</a><script type="application/javascript">$.WeiPHP.initCopyBtn("copyLink");</script>';
