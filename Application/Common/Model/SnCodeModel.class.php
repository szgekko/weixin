...
class SnCodeModel extends Model {
	...
	function getCollectCount($target_id, $addon = 'Coupon', $update = true, $cache_update = false) {
	...
	function getMyList($uid, $target_id = '', $addon = 'Coupon', $update = true, $cache_id = '') {
	...
	function getMyAll($uid, $addon = 'Coupon', $update = true, $cache_id = '', $can_use = '') {
