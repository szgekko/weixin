...
class CustomController extends Controller{
	...
	public function _initialize(){
	 ...
	 public function getAllData(){
		...
		$where['userid']  = intval(session("mid"));	 
	...
	public function exp(){
		...
		$data = ',,,,,,,,,,,,'.utf2gb('技术支持 By '.$sysinfo['web_copyright'].'').','."\n"; 		
