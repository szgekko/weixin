...
class PageController extends Controller{
	...
	public function crop(){
		$src=SITE_PATH.'/Uploads/'. I('post.src');
		$ImageCut = new \Think\ImageCut($src,I('post.x'),I('post.y'),I('post.x2'),I('post.y2'),I('post.w'),I('post.h')); 
		$returnImg=$ImageCut->generate_shot();
		$returnImg=str_replace(SITE_PATH.'/Uploads/','',$returnImg);
		$jsonstr = '{"success":true,"code":200,"msg":"操作成功","obj":"'.$returnImg.'","map":{"id":25491583,"path":"'.$returnImg.'"},"list":null}';		
			echo $jsonstr;
	}
