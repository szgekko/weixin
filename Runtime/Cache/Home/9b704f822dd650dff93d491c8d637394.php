...
<div class="login_header">
    <div class="log_wrap">
        <a href="/" title="商城"><img class="logo" src="/Public/Home/images/logo.png"/></a>
        <!--
        <div class="nav_r">
...
<section class="reg_box log_wrap">
	<form class="login-form fl" action="/index.php?s=/Home/User/register.html" method="post">
       ...
       <div class="form_body">
            ...
            <div class="controls">
              ...
              <span class="tips">该用户名将用于登录WeiPHP商城系统</span>
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              ...
              <span class="tips">用于发送商城资料</span>
              <?php if(!C('WEB_SITE_VERIFY')) { ?><div class="Validform_checktip text-warning"></div><?php } ?>
            </div>
          </div>
    ...
    <div class="fr reg_r">
    	 已有WeiPHP商城账号？<a href="<?php echo U('User/login');?>">登录</a> 
    </div>
</section>
