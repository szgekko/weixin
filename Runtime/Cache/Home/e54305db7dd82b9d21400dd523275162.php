  ...
  <section id="contents"> 
    ...
    <div class="tab-content">
    	...
    	<?php if(empty($info)): ?><!-- 还没创建店铺 -->
        	...
        	<?php if(empty($isUser)): ?><h3><center><img src="/Public/Home/images/error.png"/></center><center><br/><br/>你还没有创建店铺，请先<a href="<?php echo U('add');?>">创建店铺</a>！</center></h3>
        	<?php else: ?>
	        	<?php if(empty($can_get_shop)): ?><h3><center><img src="/Public/Home/images/error.png"/></center><center><br/><br/>你还没有创建店铺的权限！</center></h3>
	        	<?php else: ?>
	        	<h3><center><img src="/Public/Home/images/error.png"/></center><center><br/><br/>你还没有创建店铺，请先<a href="<?php echo U('add');?>">创建店铺</a>！</center></h3><?php endif; endif; ?>
        	</div>
        <?php else: ?>	
            ...
            <?php if(!empty($info["logo"])): ?><img src="<?php echo (get_cover_url($info["logo"])); ?>">
                ...
                <div class="info">
                    ...
                    <div class="shop_summary">
                        <span>在售商品: <em><?php echo (intval($count["sale_count"])); ?></em></span>
                         <span>待上架商品: <em><?php echo (intval($count["wait_count"])); ?></em></span>
                        <span>下架商品: <em><?php echo (intval($count["down_count"])); ?></em></span>
                ...
                <div class="right_btn">
                	<a class="btn" href="<?php echo addons_url('Shop://Shop/preview',array('uid'=>get_mid()));?>" target="_blank">预览店铺</a>
                    &nbsp;&nbsp;
                    <a class="border-btn" id="copyLink" href="javascript:;" data-clipboard-text="<?php echo addons_url('Shop://Wap/index',array('shop_id'=>$info['id'],'token'=>get_token(),'uid'=>get_mid()));?>">复制链接</a>
