                ...
                <?php if($field['is_show'] == 1 || $field['is_show'] == 3 || ($field['is_show'] == 5 && I($field['name']) )): ?><div class="form-item cf toggle-<?php echo ($field["name"]); ?>">
                    ...
                    <div class="controls">
                      <?php switch($field["type"]): case "num": ?><input type="number" class="text input-large" name="<?php echo ($field["name"]); ?>" value="<?php echo ($data[$field['name']]); ?>"><?php break;?>
                        <?php case "string": if($field['name']=='address'){ echo "  <input type='text' value='".$data['address']."' name='address' id='address' class='text input-large'>"; }else if($field['name']=='gps'){ echo ' <input type="hidden" value="'.$data['gps'].'" name="gps" id="gps" class="text input-large">
              <div id="map" style="height:400px;width:600px;border:1px solid #bcbcbc;"></div>'; }else{ echo "<input type='text' class='text input-large' name='".$field['name']."' value='".$data[$field['name']]."'>"; } break;?>
...
(function(){
  ...
  <script type="text/javascript" src="/Public/static/bdMap.js?v=<?php echo SITE_VERSION;?>"></script> 
  <script type="text/javascript">
  $(function(){
	 initUploadImg();
	initUploadFile();
