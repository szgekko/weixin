...
<body>
    ...
    <div class="header">
        ...
        <?php }else{ ?>
        <span class="logo" style="float: left;margin-left: 2px;width: 198px;height: 49px;background:url('./Public/Home/images/logo.png') no-repeat center" >
...
<!--         <img style="height:49px;" src="/weiphp3.0/Public/Home/images/logo.png"> -->
        ...
        <div class="user-bar">
            ...
            <ul class="nav-list user-menu hidden">
                ...
                <li><a href="<?php echo U('Home/Public/lists');?>">返回前台</a></li>
